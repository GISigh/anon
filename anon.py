...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(10, 110, 401, 41))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(10, 40, 361, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setText(_translate("MainWindow", "Type pattern to replace"))
        self.toolButton.setText(_translate("MainWindow", "..."))
        self.lineEdit_3.setText(_translate("MainWindow", "Type pattern to replace"))
